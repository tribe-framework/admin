...
class Functions {
    ...
    public function getDatatableRowArray($_object) {
        ...
        // edit new tab
        $_editForm = '';
        if (($types[$type]['disallow_editing'] ?? false) && ($types['user']['roles'][$currentUser['role_slug']]['role'] == 'admin' || ($types['user']['roles'][$currentUser['role_slug']]['role'] == 'crew' && $_object['content_privacy'] == 'pending') || $currentUser['user_id'] == $_object['user_id'])) {
